...
from ground_truth_mapping.ground_truth_mapping_run import BenchmarkRun
...
def main():
    ...
    parser.add_argument('-c', dest='grid_benchmark_configuration',
                        ...
                        type=str,
                        default="ground_truth_mapping_1.yaml",
                        required=False)
    ...
    grid_benchmark_configuration = path.expanduser(path.join("~/w/ros2_ws/src/ground_truth_mapping/config", "benchmark_configurations", args.grid_benchmark_configuration))
