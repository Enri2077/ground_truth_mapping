...
from ground_truth_mapping_ros.ground_truth_mapping_run import BenchmarkRun
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', dest='grid_benchmark_configuration',
                        ...
                        type=str,
                        default="~/w/catkin_ws/src/ground_truth_mapping/config/benchmark_configurations/ground_truth_mapping_1.yaml",
                        required=False)
